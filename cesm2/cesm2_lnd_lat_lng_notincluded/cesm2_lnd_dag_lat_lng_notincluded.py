...
dag = DAG(
    ...
    description='cesm2_lnd_dag lat_lng_not_included_in_zarr',
    schedule_interval=None,  # Set to None for one-time execution
)

download_cesm2_from_aws = BashOperator(
    task_id='execute_bash_script',
    bash_command = "bash /root/airflow/dags/download_cesm2_data.sh 's3://ncar-cesm2-lens/lnd/daily/cesm2LE-ssp370-cmip6-H2OSNO.zarr'",
    dag=dag,
)
